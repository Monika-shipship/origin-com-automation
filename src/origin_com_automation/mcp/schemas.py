...
class AnalysisOptions(StrictOptions):
    ...
    order: int | None = None
    derivative_method: Literal["gradient", "forward", "backward", "central", "differentiate", "dderivative"] | None = None
...
class CategoryMarkerOptions(StrictOptions):
    ...
    shape: Literal["circle", "square", "triangle_up", "triangle_down", "diamond", "hexagon", "star", "cross", "x"] | None = None
...
class WorksheetTransformOptions(StrictOptions):
    ...
    operator: Literal["eq", "ne", "gt", "ge", "lt", "le", "add", "subtract", "multiply", "divide", "power"] | None = None
    value: Any | None = None
    ...
    validation: Literal["one_to_one", "one_to_many", "many_to_one", "many_to_many"] | None = Field(default=None, alias="validate")
