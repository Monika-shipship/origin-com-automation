...
GRAPH_TYPES = (
    ...
    GraphType("semilog", "2d", ("x", "y"), ("worksheet",), "worksheet", 200, None, "verified"),
    GraphType("loglog", "2d", ("x", "y"), ("worksheet",), "worksheet", 200, None, "verified"),
    GraphType("bar", "2d", ("x", "y"), ("worksheet",), "worksheet", 203, None, "verified"),
    GraphType("multi_layer", "2d", ("x", "y"), ("label", "worksheet"), "worksheet", 202, None, "verified"),
